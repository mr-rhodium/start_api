...
from app.errors.exception_handlers import (
    swapi_exception_error_handler,
    character_not_found_error_handler,
    not_found_error_handler,
    server_error_handler,
    index_out_error_handler,
)
...
app.add_exception_handler(SwapiCharacterError, swapi_exception_error_handler)
...
app.add_exception_handler(IndexError, index_out_error_handler)
